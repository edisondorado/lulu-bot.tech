...
import TableLeaders from "./systems/TableLeaders";
    ...
    <div className="w-full h-screen md:h-screen m-0 p-0 bg-[#18181B] text-white">
      ...
      <div className="pt-24 md:pt-6 w-auto h-full px-2 md:ml-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <p className="text-xl font-bold hidden md:block">Лидеры</p>
          <Button
            color="success"
            size="lg"
        ...
        <TableLeaders searchInput={searchInput} isCreateUser={isCreateUser} setIsCreateUser={setIsCreateUser} />
      </div>
    </div>
  );
};
